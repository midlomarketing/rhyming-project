...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "word_select".
 */
export interface WordSelect<T extends boolean = true> {
  word?: T;
  slug?: T;
  homonyms?: T;
  pronunciations?:
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "vowel_select".
 */
